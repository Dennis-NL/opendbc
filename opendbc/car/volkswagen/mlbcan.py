...
def create_acc_hud_control(packer, bus, acc_hud_status, set_speed, lead_distance, distance, speedvisible, leadvisible, visualalert, audiblealert, hudtext):
  values = {
    ...
    "ACC_Relevantes_Objekt": 2 if visualalert == 1 else (1 if acc_hud_status == 3 else 0), # Small lead car symbol: 2 = Red symbol, 1 = Green symbol, 0 = No car visible
    "ACC_Status_Prim_Anz": 2 if visualalert == 1 else (1 if acc_hud_status == 3 else 0), # Big ACC symbol: 2 = Red symbol, 1 = Green symbol, 0 = Symbol off
