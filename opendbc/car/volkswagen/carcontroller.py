  ...
  def update(self, CC, CC_SP, CS, now_nanos):
    ...
    if self.CP.openpilotLongitudinalControl:
      if self.frame % self.CCP.ACC_CONTROL_STEP == 0:
        acc_control = self.CCS.acc_control_value(CS.out.cruiseState.available, CS.out.accFaulted, CC.longActive) if (not CC.cruiseControl.cancel or CS.brakePressed) else 2
