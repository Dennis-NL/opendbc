  ...
  def __init__(self, CP):
    ...
    if CP.flags & VolkswagenFlags.PQ:
      ...
      if CP.flags & VolkswagenFlags.MLB:
        ...
        self.STEER_DELTA_UP = 10          # Max HCA reached in 0.60s
        self.STEER_DELTA_DOWN = 10        # Min HCA reached in 0.60s

        # TODO: populate shifter enums (MLB gebruikt geen standaard mapping)
        ...
        self.STEER_DRIVER_ALLOWANCE = 80  # Driver intervention threshold 0.8 Nm
        self.STEER_DELTA_UP = 4           # Max HCA reached in 1.50s
        self.STEER_DELTA_DOWN = 10        # Min HCA reached in 0.60s
...
class CAR(Platforms):
  ...
  AUDI_Q5_MK1 = VolkswagenMLBPlatformConfig( # Chassis FL
    [
