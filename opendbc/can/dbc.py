...
from opendbc.car.volkswagen.mqbcan import volkswagen_mqb_mlb_meb_checksum, xor_checksum
...
class SignalType:
  ...
  TOYOTA_CHECKSUM = 3
  BODY_CHECKSUM = 4
  VOLKSWAGEN_MQB_MLB_MEB_CHECKSUM = 5
  XOR_CHECKSUM = 6
  SUBARU_CHECKSUM = 7
  CHRYSLER_CHECKSUM = 8
...
def get_checksum_state(dbc_name: str) -> ChecksumState | None:
  ...
  elif dbc_name.startswith(("vw_mqb", "vw_mlb", "vw_mqbevo", "vw_meb")):
    return ChecksumState(8, 4, 0, 0, True, SignalType.VOLKSWAGEN_MQB_MLB_MEB_CHECKSUM, volkswagen_mqb_mlb_meb_checksum)
